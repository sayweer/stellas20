...
const PICKER_DARK: SwkAppTheme = {
  ...PICKER_SHARED,
  background: '#1B0506',
  'background-secondary': '#140304',
  'foreground-strong': '#EED9B9',
  foreground: '#E3CBAA',
  'foreground-secondary': '#B5988A',
  lighter: '#23090A',
  light: '#1B0506',
  'light-gray': '#B5988A',
  gray: '#8A5A48',
  border: 'rgba(238, 217, 185, 0.12)',
  shadow: '0 24px 48px -12px rgba(20, 3, 4, 0.6)',
}

const PICKER_LIGHT: SwkAppTheme = {
  ...PICKER_SHARED,
  background: '#F6EDDD',
  'background-secondary': '#EEE0CC',
  'foreground-strong': '#2A0E0E',
  foreground: '#3A1614',
  'foreground-secondary': '#6F4E3D',
  lighter: '#FFFCF5',
  light: '#EEE0CC',
  'light-gray': '#96775F',
  gray: '#6F4E3D',
  border: 'rgba(42, 14, 14, 0.10)',
  shadow: '0 24px 48px -12px rgba(42, 14, 14, 0.15)',
}
...
export function setWalletTheme(theme: 'light' | 'dark'): void {
  StellarWalletsKit.setTheme(theme === 'dark' ? PICKER_DARK : PICKER_LIGHT)
}
