...
export function FaucetButton({ pending, disabled, onClick }: FaucetButtonProps): ReactElement {
  return (
    <button
      ...
      aria-busy={pending}
      className="inline-flex min-h-11 items-center gap-2 rounded-lg border border-neutral-700 px-3 py-2 text-sm font-medium text-neutral-200 transition-colors hover:bg-neutral-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-500/60 disabled:cursor-not-allowed disabled:opacity-50"
    >
      {pending ? (
