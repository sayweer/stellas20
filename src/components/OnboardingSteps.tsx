...
export function OnboardingSteps({ gotTokens, wrapped, split }: OnboardingStepsProps): ReactElement {
  ...
  return (
    <section
      ...
      className="rounded-2xl border border-emerald-500/20 bg-emerald-500/[0.04] p-5 sm:p-6"
    >
      <h2 className="text-sm font-medium text-emerald-200/80">Get started in 3 steps</h2>
